...
{	public static final ResourceKey<PlacedFeature> FLOWER_FOCUS_RAINBOW_OAK_TREES = create("flower_focus_rainbow_oak_trees");
	...
	public static void bootstrap(BootstapContext<PlacedFeature> context)
	{
		...
		PlacementUtils.register(context, FLOWER_FOCUS_RAINBOW_OAK_TREES, focusTrees, treePlacement(RarityFilter.onAverageOnceEvery(100)));
	}
